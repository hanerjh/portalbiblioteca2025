<div>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <button wire:click="create()" class="btn btn-primary"><i class="bi bi-plus-circle me-1"></i> Nuevo Evento</button>
        </div>
        <div class="card-body">
            {{-- Barra de búsqueda --}}
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                 <span class="badge {{ $evento->estado == 'publicado' ? 'bg-success' : 'bg-warning' }}">
                                    {{ ucfirst($evento->estado) }}
                                </span>
                            </td>
                            <td class="text-end">
                               <button wire:click="edit({{ $evento->id }})" class="btn btn-sm btn-info" title="Editar"><i class="bi bi-pencil"></i></button>
                               <button wire:click="delete({{ $evento->id }})" wire:confirm="¿Estás seguro?" class="btn btn-sm btn-danger" title="Eliminar"><i class="bi bi-trash"></i></button>
                            </td>
                        </tr>
                        @empty
                        <tr><td colspan="6" class="text-center">No hay eventos para mostrar.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <form>
                       <div class="mb-3">
                           ...
                           <input type="text" wire:model="titulo" wire:keyup="updatedTitulo($event.target.value)" class="form-control">
                       ...
                       <div class="row">
                        ...
                        <div class="mb-3">
                           ...
                           <input type="text" wire:model="lugar" class="form-control" placeholder="Ej: Auditorio principal o Zoom">
                       </div>
                       <div class="mb-3">
