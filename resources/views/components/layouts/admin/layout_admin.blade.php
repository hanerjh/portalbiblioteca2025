...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('resource/assets/compiled/svg/favicon.svg')}}" type="image/x-icon">
...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="{{ asset('public/apple-touch-icon.png') }}" alt="Logo" srcset=""></a>
            </div>
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                         <a href="" class="submenu-link">Registrar</a>                        
                    </li>
                    <li class="submenu-item  ">
                         <a href="" class="submenu-link">Actualizar</a>                        
                    </li>                    
                </ul>
            </li>
