...
class GestionProgramaAcademico extends Component
{
    use WithPagination;
    ...
    {
        $programaacademico = ProgramaAcademico::paginate(10);
       
       // $menus = Menu::paginate(10);
        
        return view('livewire.admin.gestion-programa-academico', compact('programaacademico'));
    }
    ...
    public function store()
    {
       ...
       // dd($baget);
       ProgramaAcademico::updateOrCreate(['id' => $this->menu_id], [
            'nombre' => $this->nombre,
    ...
    {
        $menu = ProgramaAcademico::findOrFail($id);
        $this->menu_id = $id;
    ...
    {
        ProgramaAcademico::find($id)->delete();
